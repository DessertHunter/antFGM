 ...
 *
 */
#include "ANT_FGM_Page_2.h"
#include "ANT_FGM_Page_Logger.h"

/**@brief FGM page 2 data layout structure. */
typedef struct
{
    uint8_t manuf_id;
 ...
 */
static void page2_data_log(ant_fgm_page2_data_t const * p_page_data)
{
...
void ant_fgm_page_2_encode(uint8_t                    * p_page_buffer,
                           ant_fgm_page2_data_t const * p_page_data)
{
    ant_fgm_page2_data_layout_t * p_outcoming_data = (ant_fgm_page2_data_layout_t *)p_page_buffer;
...
void ant_fgm_page_2_decode(uint8_t const        * p_page_buffer,
                           ant_fgm_page2_data_t * p_page_data)
{
    ant_fgm_page2_data_layout_t const * p_incoming_data =
        (ant_fgm_page2_data_layout_t *)p_page_buffer;
    uint32_t serial_num =
