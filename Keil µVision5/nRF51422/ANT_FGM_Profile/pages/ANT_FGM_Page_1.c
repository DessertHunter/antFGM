 ...
 *
 */
#include "ANT_FGM_Page_1.h"
#include "ANT_FGM_Utils.h"
#include "ANT_FGM_Page_Logger.h"
#include "app_util.h"
#include "nordic_common.h"

/**@brief FGM page 1 data layout structure. */
typedef struct
{
 ...
 */
static void page1_data_log(ant_fgm_page1_data_t const * p_page_data)
{
    LOG_PAGE1("Cumulative operating time:        %ud ",
              (unsigned int)ANT_FGM_OPERATING_DAYS(p_page_data->operating_time));
    LOG_PAGE1("%uh ", (unsigned int)ANT_FGM_OPERATING_HOURS(p_page_data->operating_time));
    LOG_PAGE1("%um ", (unsigned int)ANT_FGM_OPERATING_MINUTES(p_page_data->operating_time));
    LOG_PAGE1("%us\n\r", (unsigned int)ANT_FGM_OPERATING_SECONDS(p_page_data->operating_time));
}
